  ...
  return (
    <div className="container">
      ...
      <section className="hero">
        <h1 className="display">Make podcast clips that spread.</h1>
        <p className="lede">
          ClipForge detects quotable moments, adds captions and layouts, and exports vertical clips for Reels, Shorts, and TikTok.
        </p>
        <div className="cta-row">
          <a className="btn btn-primary" href="#waitlist">Join the Podcasters Beta</a>
      ...
      <section id="waitlist" className="card" style={{marginTop: 12}}>
        ...
        <div dangerouslySetInnerHTML={{ __html: process.env.NEXT_PUBLIC_FORM_EMBED_PODCASTERS ?? '' }} />
