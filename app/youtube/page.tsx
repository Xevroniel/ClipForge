  ...
  return (
    <div className="container">
      ...
      <section className="hero">
        <h1 className="display">Turn one long YouTube video into 10 shorts.</h1>
        <p className="lede">
          ClipForge finds highlights, auto-captions, resizes to 9:16, and prepares titles, descriptions, and tags for Shorts.
        </p>
        <div className="cta-row">
